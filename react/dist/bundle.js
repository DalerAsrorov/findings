...
/***/ "./src/ComponentVsPureComponent/BoxIncrement.tsx":
/*!*******************************************************!*\
  !*** ./src/ComponentVsPureComponent/BoxIncrement.tsx ***!
  \*******************************************************/
/*! no static exports found */
...
class BoxIncrement extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            counter: 1
    ...
    render() {
        ...
        const boxes = [...Array(counter)].map((el, i) => (React.createElement("article", { key: i, style: BOX_STYLE })));
        return (React.createElement("div", { style: CONTAINER_STYLE },
            React.createElement("section", { style: Object.assign({}, BOX_CONTAINER_STYLE, SECTION_STYLE) }, boxes)));
    }
}
exports.default = BoxIncrement;


/***/ }),

/***/ "./src/ComponentVsPureComponent/index.tsx":
/*!************************************************!*\
  !*** ./src/ComponentVsPureComponent/index.tsx ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const BoxIncrement_1 = __webpack_require__(/*! ./BoxIncrement */ "./src/ComponentVsPureComponent/BoxIncrement.tsx");
const withPureComponentTypeSub_1 = __webpack_require__(/*! ../hocs/withPureComponentTypeSub */ "./src/hocs/withPureComponentTypeSub.tsx");
// constants
const MAX_COLUMN_NUM = 10;
const UPDATE_INTERVAL_MLS = 3000;
// styles
...
class PureComponentVsComponentExample extends React.Component {
    ...
    render() {
        ...
        const EnhancedBoxIncrement = withPureComponentTypeSub_1.default(BoxIncrement_1.default, shouldUsePureComponent);
        return (React.createElement("div", { style: CONTAINER_STYLE },
            React.createElement("section", { style: { flex: 1, width: '100%' } },
                React.createElement(EnhancedBoxIncrement, null)),
            React.createElement("section", { style: { flex: 1, width: '100%', textAlign: 'center' } },
                React.createElement("button", { onClick: this.handleSwitch },
...
/***/ "./src/hocs/withPureComponentTypeSub.tsx":
/*!***********************************************!*\
  !*** ./src/hocs/withPureComponentTypeSub.tsx ***!
  \***********************************************/
/*! no static exports found */
...
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const UPDATE_INTERVAL_MLS = 3000;
const withComponentType = (WrappedComponent, shouldUsePureComponent) => {
    ...
    return class PureComponentVsComponent extends ComponentType {
        ...
        render() {
            return React.createElement(WrappedComponent, Object.assign({}, this.state, this.props));
        }
    };
};
exports.default = withComponentType;
...
const ComponentVsPureComponent_1 = __webpack_require__(/*! ./ComponentVsPureComponent */ "./src/ComponentVsPureComponent/index.tsx");
ReactDOM.render(React.createElement(ComponentVsPureComponent_1.default, null), document.getElementById('app'));
